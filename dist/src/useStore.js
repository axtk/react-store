...
export function useStore(store, getUpdateTrigger) {
    ...
    let setUpdateTrigger = useState(getUpdateTrigger == null ? undefined : getUpdateTrigger(resolvedStore))[1];
    useEffect(() => {
